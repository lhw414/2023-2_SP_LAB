...
| Date | Description |
|:---  |:--- |
| Monday, September 18, 18:30 | I/O Lab hand-out |
| Monday, September 25, 18:30 | I/O Lab session 1 |
| Tuesday, October 3, 23:59 | Submission deadline |

Remember that you have to attend one of the lab sessions in-person, either in the computer labs in 44-1 or via the live stream in 302-311-1. 
We invite you to ask questions in Slack and arrange meetings with our TAs if you have trouble solving the lab.
...
The lab is handed out via https://teaching.csap.snu.ac.kr/system-programming/fall-2023/labs/lab-2-input-and-output.

Start by forking the lab into your namespace, then **verify that that the lab's visibility is set to private** (this should be the default). Read the instructions here carefully.  Finally, clone the lab to your local computer and get to work. 

### Submission

Commit and push your work frequently to avoid data loss. Once you are happy with your solution and want to submit it for grading, create a tag called "Submission". **When you push your "Submission" tag, The timestamp on the server is considered your submission time**.

To create a tag, go to your I/O lab repository on https://teaching.csap.snu.ac.kr/ and navigate to Repository -> Tags. Enter "Submission" as the Tag name then hit "Create tag". You can leave the other fields empty. You can also create and push tags via the comand line - consult the Internet to find out how.  
...
Note that we evaluate your submissions in the provided CSAP VM. If you not use the CSAP VM to develop your code, we recommend to test your submission in the CSAP VM to make sure it runs correctly.
